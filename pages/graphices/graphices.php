...
<body>
    <div class="container-fluid p-3 text-center">
        ...
        <img src="./img/hero-img.webp" class="graphices-head-img" alt="Hero Image" title="Hero Img">
    </div>
    <!-- -->
    <!-- Photoshop -->
    <!-- -->
    <div class="container-fluid ">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-sm-12 p-5 fade-in">
            ...
            <div class=" col-lg-5 col-sm-12 text-center align-items-center  align-content-center fade-in"> <img src="./img/adobe-photoshop.webp" class="photoshop-Symbol-size" alt="Adobe Photoshop Image" title="Adobe Photoshop Image"></div>
        </div>
    </div>
    <h2 class="graphices-head-color px-5 mt-5">Services</h2>
    <div class="container-fluid p-5">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-sm-12 p-5 align-content-center graphices-card1 from-left slide-in">
            ...
            <div class=" col-lg-5 col-sm-12  p-5 graphices-card from-right slide-in">
    ...
    <div class="container-fluid mt-3">
        <div class="row justify-content-center bo-color">
            ...
            <div class=" col-lg-5 col-sm-12 text-center align-items-center  align-content-center fade-in"> <img src="./img/Canva.png" class="photoshop-Symbol-size" alt="canva-Symbol" title="Canva"></div>
        </div>
    </div>
    <h2 class="graphices-head-color px-5 mt-5">Services</h2>
    <div class="container-fluid p-5">
    ...
    <div class="container-fluid ">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-sm-12 p-5 fade-in">
                <h3 class="graphices-head-color my-4">Adobe Illustrator</h3>
                <p class="textAlignent">
            ...
            <div class=" col-lg-5 col-sm-12 text-center align-items-center  align-content-center fade-in"> <img src="./img/adobe-illustrator.webp" class="photoshop-Symbol-size" alt="Adobe Illustrator Image" title="Adobe Illustrator"></div>
        </div>
    </div>
    <h2 class="graphices-head-color px-5 mt-5">Services</h2>
    <div class="container-fluid p-5">
    ...
    <div class="container-fluid mt-3">
        <div class="row justify-content-center bo-color">
            ...
            <div class=" col-lg-5 col-sm-12 text-center align-items-center  align-content-center fade-in"> <img src="./img/adobe-premiere.png" class="photoshop-Symbol-size" alt="Adobe Premiere Image" title="Adobe Premiere"></div>
        </div>
    </div>
    <h2 class="graphices-head-color px-5 mt-5">Services</h2>
    <div class="container-fluid p-5">
